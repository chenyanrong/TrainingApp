package com.tonychen.trainingapp.view.subactivity;
...
import com.tonychen.trainingapp.utils.FaceUtil;
 ...
 */
public class OnlineFaceDemoActivity extends BaseTitleActivity implements OnClickListener {
    ...
    protected void initView() {
        super.initView();
        EditText et_online_authid = (EditText) findViewById(R.id.online_authid);
        et_online_authid.setText(UUID.randomUUID().toString());
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpeechUtility.createUtility(this, "appid=" + Attribute.XFLY_APPID);
        findViewById(R.id.online_pick).setOnClickListener(OnlineFaceDemoActivity.this);
        findViewById(R.id.online_reg).setOnClickListener(OnlineFaceDemoActivity.this);
        findViewById(R.id.online_verify).setOnClickListener(OnlineFaceDemoActivity.this);
        findViewById(R.id.online_camera).setOnClickListener(OnlineFaceDemoActivity.this);
        findViewById(R.id.online_detect).setOnClickListener(OnlineFaceDemoActivity.this);
        findViewById(R.id.online_align).setOnClickListener(OnlineFaceDemoActivity.this);
    ...
    public void onClick(View view) {
        ...
        Snackbar.make(getContentView(), "接入文档有问题,请先别测试该项目!", 3000).show();
//        switch (view.getId()) {
...
//            FaceUtil.cropPicture(this, Uri.fromFile(new File(fileSrc)));
            ...
            if (null != bmp) {
                FaceUtil.saveBitmapToFile(OnlineFaceDemoActivity.this, bmp);
            }
            // 获取图片保存路径
            fileSrc = FaceUtil.getImagePath(OnlineFaceDemoActivity.this);
            // 获取图片的宽和高
