...
public class SPUtil {
        ...
        public static void putData(String key, Object data) {
            putData(AppUtil.getApplicationContext(), SP_NAME, key, data);
        }
        ...
        public static void putData(String spName, String key, Object data) {
            putData(AppUtil.getApplicationContext(), spName, key, data);
        }
        ...
        public static Object getData(String key, Object defValue) {
            return getData(AppUtil.getApplicationContext(), SP_NAME, key, defValue);
        }
        ...
        public static Object getData(String spName, String key, Object defValue) {
            return getData(AppUtil.getApplicationContext(), spName, key, defValue);
        }
        ...
        public static void remove(String key) {
            remove(AppUtil.getApplicationContext(), key);
        }
        ...
        public static void remove(String spName, String key) {
            remove(AppUtil.getApplicationContext(), spName, key);
        }
        ...
        public static void clearAll() {
            clearAll(AppUtil.getApplicationContext(), SP_NAME);
        }
        ...
        public static void clearAll(String spName) {
            clearAll(AppUtil.getApplicationContext(), spName);
        }
